...
private const val YOUTUBE_API = "AIzaSyAhPaRZg3clO1muxnfGpG-fcSRfaIHg5HM"
...
class DetailActivity : YouTubeBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        client.get(URL.format(movie.movieId), object: JsonHttpResponseHandler() {
            override fun onFailure(
                ...
                Log.e(TAG, "Failing Youtube API")
            }

            override fun onSuccess(statusCode: Int, headers: Headers?, json: JSON) {
                Log.e(TAG, "Working Youtube API")
    ...
    private fun initalizeYoutube(youtubeKey: String) {
        ytPlayerView.initialize(YOUTUBE_API, object: YouTubePlayer.OnInitializedListener {
